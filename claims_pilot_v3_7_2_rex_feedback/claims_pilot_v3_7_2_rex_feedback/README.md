# ClaimsPilot V3.6.8 - Qualification DO
...
La V3.6.8 supprime l'usage de `st.form` pour limiter les blocages Streamlit Cloud et ajoute un bouton **Nouvelle analyse / reset** destiné à remplacer le reboot de l'application.



## V3.6.8 - verrou usure normale / âge du sinistre
...
## V3.6.8 - ESS toiture / cause étrangère non neutralisée
...
La version V3.7.2 ajoute un espace de retour d'expérience permettant de télécharger un fichier texte contenant à la fois la réponse de l'application et la réponse expert attendue pour un cas d'usage donné.
